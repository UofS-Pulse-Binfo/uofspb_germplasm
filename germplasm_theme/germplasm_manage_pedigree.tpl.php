<div id="tripal_stock-germplasm_pedigree-box" class="germplasm_manage-info-box tripal-info-box"> 
  ...
  <table class="tripal_germplasm_manage-table tripal-table tripal-table-horz">
    <tr><th>Pedigree</th></tr>      
    <?php if (!empty($pedigree_string)) { ?>
      <tr><td class="tripal_germplasm_manage-table-even-row tripal-table-even-row"><?php print $pedigree_string; ?></td></tr>
    <?php } ?>
  </table>
